...
public class MenuTestActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cooper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (extras != null) {
                    ...
                    Intent i = new Intent(MenuTestActivity.this, CooperActivity.class);
        ...
        flexiones.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (extras != null) {
                    ...
                    Intent i = new Intent(MenuTestActivity.this, FlexionesActivity.class);
                    i.putExtra("cedula",cedula);
                    i.putExtra("usuario",usuario.toString());
                    i.putExtra("contrasena",contrasena.toString());
                    startActivity(i);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MenuTestActivity.this, Logout.class);
                startActivity(i);
            }
        });
    }
